                ...
                <nav className="flex flex-col flex-1">
                  <ul role="list" className="flex flex-col flex-1 gap-y-7">
                    ...
                    <li className="mt-auto">
                      <a
                        href="#"
                        className="flex p-2 -mx-2 font-semibold text-indigo-200 rounded-md group gap-x-3 text-sm/6 hover:bg-indigo-700 hover:text-white"
                      >
                        <Cog6ToothIcon
                          aria-hidden="true"
                          className="text-indigo-200 size-6 shrink-0 group-hover:text-white"
                        />
                        Settings
                      </a>
                    </li>
            ...
            <div className="flex self-stretch flex-1 gap-x-4 lg:gap-x-6">
              <form action="#" method="GET" className="grid flex-1 grid-cols-1">
                <input
                  ...
                  placeholder="Search"
                  aria-label="Search"
                  className="block col-start-1 row-start-1 pl-8 text-base text-gray-900 bg-white outline-none size-full placeholder:text-gray-400 sm:text-sm/6"
                />
                <MagnifyingGlassIcon
                  aria-hidden="true"
