...
const DatatableList = () => {
  ...
  }, [tableContainerRef.current, headerRef.current]);
  ...
  return (
    ...
    >
      ...
      <div className="scrollbar-hide relative overflow-auto" ref={headerRef}>
        <div
          id="datatable-header-row"
          key={"table-header"}
          className={cn(
            "group z-10 flex border-b-2 font-normal",
            "border-gray-300",
      ...
      >
        <div
          ...
          style={{
            width: "100%",
            height: rowVirtualizer.getTotalSize() + (isFetching ? 50 : 0),
            minWidth: `${table.getTotalSize()}px`,
          }}
        >
          {isResizing ? (
